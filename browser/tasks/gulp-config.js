...
let config = {
    React: {
        ...
        BrowserRootPath: "./tmp",
        // SampleCopyPath: "../samples",
        SampleCopyPath: "../samples",
        SampleCopyFiles: [".tsx", ".ts", ".css", ".csv", ".html", ".png", ".svg" ],
        SampleFileExtension: ".tsx",
        SampleFileExclusions: ["Component.ts", "State.ts", "Props.ts", "Base.ts", "Data.ts", "Pager.tsx", "LegendOverlay.tsx"],
        // SampleFileExclusions: ["Component.ts", "State.ts", "Props.ts", "Base.ts", "index.tsx"],
