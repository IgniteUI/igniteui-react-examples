...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "igniteui-react-core"                     , version: "18.2.0-beta.3" },
        { name: "igniteui-react-charts"                   , version: "18.2.0-beta.3" },
        { name: "igniteui-react-excel"                    , version: "18.2.0-beta.3" },
        { name: "igniteui-react-gauges"                   , version: "18.2.0-beta.3" },
        { name: "igniteui-react-grids"                    , version: "18.2.0-beta.3" },
        { name: "igniteui-react-inputs"                   , version: "18.2.0-beta.3" },
        { name: "igniteui-react-layouts"                  , version: "18.2.0-beta.3" },
        { name: "igniteui-react-maps"                     , version: "18.2.0-beta.3" },
        { name: "igniteui-react-spreadsheet-chart-adapter", version: "18.2.0-beta.3" },
        { name: "igniteui-react-spreadsheet"              , version: "18.2.0-beta.3" },
        { name: "igniteui-react-datasources"              , version: "18.2.0-beta.3" },
        { name: "igniteui-react"                          , version: "18.2.0-beta.3" },
