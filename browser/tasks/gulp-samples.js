...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "^19.0.2-beta.2", name: "igniteui-react-core" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-charts" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-excel" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-gauges" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-data-grids" },
        { version: "^19.2.0", name: "igniteui-react-grids" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-inputs" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-layouts" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-maps" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-spreadsheet-chart-adapter" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-spreadsheet" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-datasources" },
        { version: "^19.0.2-beta.2", name: "igniteui-react-dashboards" },
