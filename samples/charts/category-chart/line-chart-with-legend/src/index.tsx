...
export default class CategoryChartLineChartWithLegend extends React.Component<any, any> {
    public data: any[];
...
ReactDOM.render(<CategoryChartLineChartWithLegend />, document.getElementById('root'));