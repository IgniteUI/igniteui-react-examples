...
This folder contains implementation of React application with example of Data Chart Stacked100 Bar Series.
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <body>
        <a target="_blank" href="https://codesandbox.io/s/github/IgniteUI/igniteui-react-examples/tree/master/samples/charts/data-chart/type-stacked-100-bar-series?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/DataChartTypeStacked100BarSeries.tsx" rel="noopener noreferrer">
...
href="https://codesandbox.io/embed/github/IgniteUI/igniteui-react-examples/tree/master/samples/charts/data-chart/type-stacked-100-bar-series?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/DataChartTypeStacked100BarSeries.tsx">
...
<!-- <iframe
  src="https://codesandbox.io/embed/github/IgniteUI/igniteui-react-examples/tree/master/samples/charts/data-chart/type-stacked-100-bar-series?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/DataChartTypeStacked100BarSeries.tsx"
...
[./src/DataChartTypeStacked100BarSeries.tsx](./src/DataChartTypeStacked100BarSeries.tsx) file.

<!-- The following section provides source code from:
`./src/DataChartTypeStacked100BarSeries.tsx` file: -->
...
export default class DataChartTypeStacked100BarSeries extends React.Component<any, any> {
    public data: any[];
            ...
            <div className="igContainer">
                ...
                <div className="igComponent" style={{height: "calc(100% - 35px)"}}>
                    <IgrDataChart ref={this.onChartRef}
                        ...
                        <IgrStacked100BarSeries name="series"
                        xAxisName="xAxis"
                        yAxisName="yAxis"
...
cd ./samples/charts/data-chart/type-stacked-100-bar-series
npm install
npm start
