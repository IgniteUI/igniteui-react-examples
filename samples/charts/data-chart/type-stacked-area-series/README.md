...
This folder contains implementation of React application with example of Data Chart Stacked Area Series.
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <body>
        <a target="_blank" href="https://codesandbox.io/s/github/IgniteUI/igniteui-react-examples/tree/master/samples/charts/data-chart/type-stacked-area-series?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/DataChartTypeStackedAreaSeries.tsx" rel="noopener noreferrer">
...
href="https://codesandbox.io/embed/github/IgniteUI/igniteui-react-examples/tree/master/samples/charts/data-chart/type-stacked-area-series?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/DataChartTypeStackedAreaSeries.tsx">
...
<!-- <iframe
  src="https://codesandbox.io/embed/github/IgniteUI/igniteui-react-examples/tree/master/samples/charts/data-chart/type-stacked-area-series?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/DataChartTypeStackedAreaSeries.tsx"
...
[./src/DataChartTypeStackedAreaSeries.tsx](./src/DataChartTypeStackedAreaSeries.tsx) file.

<!-- The following section provides source code from:
`./src/DataChartTypeStackedAreaSeries.tsx` file: -->
            ...
            <div className="igContainer">
                ...
                <div className="igComponent" style={{height: "calc(100% - 35px)"}}>
                    <IgrDataChart ref={this.onChartRef}
                        ...
                        <IgrStackedAreaSeries name="series"
                        xAxisName="xAxis"
                        yAxisName="yAxis"
...
cd ./samples/charts/data-chart/type-stacked-area-series
npm install
npm start
