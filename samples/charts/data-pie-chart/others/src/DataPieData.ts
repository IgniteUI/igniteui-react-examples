    ...
    public constructor(items: Array<DataPieDataItem> | number = -1) {
        if (Array.isArray(items)) {
            ...
            const newItems = [
                ...
                new DataPieDataItem({ v1: 15, category: `Utilities` }),
                new DataPieDataItem({ v1: 10, category: `Heating` }),
                new DataPieDataItem({ v1: 5, category: `Lighting` }),
                new DataPieDataItem({ v1: 4, category: `Electric` }),
                new DataPieDataItem({ v1: 3, category: `Misc` }),
            ];
