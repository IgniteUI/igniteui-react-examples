    ...
    public render(): JSX.Element {
        return (
            <div className="igContainer">
                <label className="igOptions-label">Sparkline with Line Display Type</label>
                ...
                <label className="igOptions-label">Sparkline with Area Display Type</label>
                <div className="igComponent">
                    <IgrSparkline height="100%" width="100%" displayType="Area"
                        dataSource={this.data} minimum={-1} maximum={1}
                        valueMemberPath="Value" labelMemberPath="Angle"/>
                </div>
                <label className="igOptions-label">Sparkline with Column Display Type</label>
                <div className="igComponent">
                    <IgrSparkline height="100%" width="100%" displayType="Column"
                        dataSource={this.data} minimum={-1} maximum={1}
                        valueMemberPath="Value" labelMemberPath="Angle"/>
                </div>
                <label className="igOptions-label">Sparkline with WinLoss Display Type</label>
                <div className="igComponent">
