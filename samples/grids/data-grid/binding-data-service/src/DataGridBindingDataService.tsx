        ...
        return (
            <div className="igContainer">
                ...
                dataSource={this.data}>
                    ...
                    <IgrTextColumn width="*>130"  propertyPath="Settlement" />
                    ...
                    <IgrNumericColumn width="*>130" propertyPath="Change(%)" negativeSuffix="%" positiveSuffix="%" minFractionDigits={2} maxFractionDigits={2}/>
