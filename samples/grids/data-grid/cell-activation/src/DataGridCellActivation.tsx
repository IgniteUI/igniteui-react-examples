...
export default class DataGridCellActivation extends React.Component<any, any> {
    ...
    constructor(props: any) {
        ...
        this.state = { canMoveAfterEdit: true, enterBehavior: EnterKeyBehaviors.Edit,  enterBehaviorAfterEdit: EnterKeyBehaviorAfterEdit.MoveDown}
        ...
        return (
            <div className="igContainer">
                <div className="igOptions">
                    <span className="igOptions-item">Enter Key Mode: </span>
                    <select className="igOptions-item" value={this.state.enterBehavior}
                    ...
                    <span className="igOptions-item">Enter Key After Edit Mode: </span>
                    <select disabled={!this.state.canMoveAfterEdit} id="enterAfterEditMode" className="igOptions-item" value={this.state.enterBehaviorAfterEdit}
