...
export default class Sample extends React.Component<any, any> {
    ...
    public webGridDiscontinuedCellTemplate = (props: {dataContext: IgrCellTemplateContext}) => {
        if (props.dataContext.cell.value) {
            return <img src="https://dl.infragistics.com/x/img/gridactive.png" title="Continued" alt="Continued" />;
        } else {
            return <img src="https://dl.infragistics.com/x/img/gridexpired.png" title="Discontinued" alt="Discontinued" />;
        }
    };
