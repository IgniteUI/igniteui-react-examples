...
import { IgrGridMergeStrategy } from 'igniteui-react-grids';
        ...
        <>
            <div className="container sample ig-typography">      
                <div className="container fill">
                    <IgrGrid autoGenerate={false} data={data} cellMergeMode={cellMergeMode} mergeStrategy={perProjectMergeStrategy} width="100%" height="570px">
                        <IgrColumn field="ActionID" header="Action ID" hidden={true}>
                        </IgrColumn>
                        <IgrColumn field="ProjectName" header="Project Name" merge={true}>
                        </IgrColumn>
                        <IgrColumn field="Type" header="Type" merge={true}>
                        </IgrColumn>
                        <IgrColumn field="Priority" header="Priority" merge={true}> 
                        </IgrColumn>
                        <IgrColumn field="Status" header="Status" merge={true}>
                        </IgrColumn>
                        <IgrColumn field="ActionName" header="Action">
                        </IgrColumn>
...
export class PerProjectMergeStrategy implements IgrGridMergeStrategy {
