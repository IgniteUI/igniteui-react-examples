        ...
        <div className="container sample">
            <div className="button-container">
                <div className="button-item">
                    ...
                    <IgrIconButton name="add" collection="material" variant="contained" disabled={true} />
                </div>
                <div className="button-item">
                    ...
                    <IgrIconButton name="add" collection="material" variant="outlined" disabled={true} />
                </div>
                <div className="button-item">
                    ...
                    <IgrIconButton name="add" collection="material" variant="flat" disabled={true} />
                </div>
                <div className="button-item">
