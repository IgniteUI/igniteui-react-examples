        ...
        return (
            <div className="container sample">
                <div className="slider-component">
                    <IgrSlider style={{padding: "30px 30px  0px 30px"}} ref={this.sliderRef} onInput={this.onInput} value={40} />
                    <div style={{paddingLeft: "30px", display: "flex"}}>
                        <span style={{whiteSpace: "pre"}}>Value:</span>
                        <span id="slider-value"></span>
                    </div>

                    <IgrRangeSlider style={{padding: "30px 30px  0px 30px"}} ref={this.rangeSliderRef} onInput={this.onRangeInput} lower={20} upper={70}></IgrRangeSlider>
                    <div style={{paddingLeft: "30px", display: "flex"}}>
