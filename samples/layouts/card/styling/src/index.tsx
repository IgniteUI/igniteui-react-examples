...
import { IgrCard, IgrCardMedia, IgrCardHeader, IgrCardContent, IgrCardActions, IgrIconButton, IgrRipple, IgrCardModule, IgrIconButtonModule, IgrRippleModule, registerIconFromText } from 'igniteui-react';
                    ...
                    <IgrCard>
                        ...
                        <IgrCardActions key="actions">
                            <div key="actionsEndSlot" slot="end">
                                <IgrIconButton key="twitterBtn" name="twitter" collection="material">
