            ...
            <div id="sampleContainer" className="container sample">
                <igc-dockmanager id="dockManager" height="100%" width="100%">
                        ...
                        <IgrCard className="auto-y-overflow" elevated>
                            <IgrCardContent>
                                <div className="account-content">
                                    ...
                                    <IgrAvatar className="margin-avatar" src="https://static.infragistics.com/xplatform/images/flags/USA.png" shape="rounded">
                                            <span>USA</span>
                                    </IgrAvatar>
                                </div>
                            </IgrCardContent>
                    ...
                    <div className="dockManagerFull" slot="content5">
                        <IgrCard className="auto-y-overflow" elevated>
                            <IgrCardContent>                                
                                <IgrButton className="add-card-btn" variant="flat">
                                    <span>+ Add Card</span>
                                </IgrButton>                                
                                <IgrList id="list" className="auto-y-overflow">
                                    <IgrListItem>
