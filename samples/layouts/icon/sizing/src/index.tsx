        ...
        return (
            <div className="container sample">
                <div className="horizontal-border-container">
                    <IgrIcon ref={this.iconRef} className="smallIcon" name="build" collection="material" />
                    <IgrIcon className="mediumIcon" name="build" collection="material" />
                    <IgrIcon className="largeIcon" name="build" collection="material" />
                </div>
            </div>
        );
    }
