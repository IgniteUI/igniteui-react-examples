                ...
                <IgrStepper ref={this.stepperRef} linear={this.state.linear} >
                    <IgrStep key="info-step" invalid={this.state.linear && this.state.firstStepInvalid}>
                        ...
                        <form ref={this.InfoForm}>
                            ...
                            <IgrButton disabled={this.state.linear && this.state.firstStepInvalid} clicked={() => { this.stepperRef.current.next(); }}><span key="info-next">NEXT</span></IgrButton>
                        </form>
                    </IgrStep>
                    <IgrStep key="address-step" invalid={this.state.linear && this.state.secondStepInvalid}>
                        ...
                        <form ref={this.AddressForm}>
                            ...
                            <IgrButton clicked={() => { this.stepperRef.current.prev(); }}><span key="address-prev">PREVIOUS</span></IgrButton>
                            <IgrButton disabled={this.state.linear && this.state.secondStepInvalid} clicked={() => { this.stepperRef.current.next(); }}><span key="address-next">NEXT</span></IgrButton>
                        </form>
                    </IgrStep>
                    <IgrStep key="billing-step" optional>
                        ...
                        <form>
                            ...
                            <IgrButton clicked={() => { this.stepperRef.current.prev(); }}><span key="billing-prev">PREVIOUS</span></IgrButton>
                            <IgrButton clicked={() => { this.stepperRef.current.next(); }}><span key="billing-next">NEXT</span></IgrButton>
                        </form>
                    </IgrStep>
                    <IgrStep key="payment-step">
                        ...
                        <IgrButton clicked={() => { this.stepperRef.current.prev(); }}><span key="payment-prev">PREVIOUS</span></IgrButton>
                        <IgrButton clicked={() => { this.stepperRef.current.next(); }}><span key="payment-submit">SUBMIT</span></IgrButton>
                    </IgrStep>
                    <IgrStep key="status-step">
                        ...
                        <IgrButton clicked={() => { this.stepperRef.current.prev(); }}><span key="status-prev">PREVIOUS</span></IgrButton>
                        <IgrButton clicked={() => { this.stepperRef.current.reset(); }}><span key="status-reset">RESET</span></IgrButton>
                    </IgrStep>
                </IgrStepper>
            </div>
        );
