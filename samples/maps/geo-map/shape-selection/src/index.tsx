...
import { boolCompare, IgrShapeDataSource, Random } from 'igniteui-react-core';
...
export default class MapShapeStyling extends React.Component<any, any> {
    ...
    public render(): JSX.Element {
        ...
        for (let i = 0; i < this.usaStates.length; i++) {
            ...
            let info = item.Info;
            // let info = (i+1) + ". " + item.Name + " (" + item.Code + ")";
            let electors = "Electors: " + item.Electors; 
            let pop = "Population: " + WorldUtils.toStringAbbr(item.Population); 
            ...
            <div className="container vertical" style={{background: "transparent"}}>
                ...
                <div className="container sample horizontal">
                    ...
                    <div className="container vertical sideMenu" style={{background: "transparent", width: widthMenu}}>
                        ...
                        <div className="horizontal statePickerItem" style={{borderRadius: "0rem", background: "transparent", opacity: "100%"}} >
                            <div className="vertical statePickerInfo"  > 
                                <div>State Voting Outcome</div> 
                            </div>
                            <div className="horizontal" > 
                                <div className="statePickerPartyInfo"> DEM </div>
                                <div className="statePickerPartyInfo"> REP </div>
                            </div>
                        </div>
                    ...
                    <div className="container vertical" style={{background: "transparent", width: widthContent }}>
                        ...
                        <div className="container vertical electionResult" >
                            ...
                            <div className="container horizontal" style={{alignItems: "center",  }}>
                                
                                <div className="candidateInfo horizontal" style={{color: this.partyColorDEM}}>  
                                ...
                                <div className="electionGauge"  >
                                    <IgrLinearGauge
                                        ...
                                        <IgrLinearGraphRange name="range1"
                                            ...
                                            outerStartExtent={0.55} outerEndExtent={0.55}  />
    ...
    public onDataLoaded(sds: IgrShapeDataSource, e: any) {
        ...
        for (let i = 0; i < smallStates.length; i++) {
            ...
            item.Y = this.usaData["NH"].Y - ((i +1) * 1.25);
        }
        ...
        // xMin -= 30;
        // yMin -= 1;
        // let geoRegion = { left: xMin, top: yMin, width: xMax - xMin, height: yMax - yMin};
    ...
    public usaData: any = {
        AK: {Code: 'AK', Party: 'R', Electors: 3, Voters: 333151, Population: 731545},
        AL: {Code: 'AL', Party: 'R', Electors: 9, Voters: 2014244, Population: 4903185},
        AR: {Code: 'AR', Party: 'R', Electors: 6, Voters: 1057163, Population: 3017825},
        AZ: {Code: 'AZ', Party: 'D', Electors: 11, Voters: 3241478, Population: 7278717},
        CA: {Code: 'CA', Party: 'D', Electors: 55, Voters: 24113728, Population: 39512223},
        CO: {Code: 'CO', Party: 'D', Electors: 9, Voters: 3759070, Population: 5758736},
        CT: {Code: 'CT', Party: 'D', Electors: 7, Voters: 2472120, Population: 3565287},
        DC: {Code: 'DC', Party: 'D', Electors: 3, Voters: 768547, Population: 705749},
        DE: {Code: 'DE', Party: 'D', Electors: 3, Voters: 650886, Population: 973764},
        FL: {Code: 'FL', Party: 'R', Electors: 29, Voters: 23595237, Population: 21477737},
        GA: {Code: 'GA', Party: 'R', Electors: 16, Voters: 10082120, Population: 10617423},
        HI: {Code: 'HI', Party: 'D', Electors: 4, Voters: 736560, Population: 1415872},
        IA: {Code: 'IA', Party: 'R', Electors: 6, Voters: 3620050, Population: 3155070},
        ID: {Code: 'ID', Party: 'R', Electors: 4, Voters: 540697, Population: 1787147},
        IL: {Code: 'IL', Party: 'D', Electors: 20, Voters: 8554565, Population: 12671821},
        IN: {Code: 'IN', Party: 'R', Electors: 11, Voters: 2923433, Population: 6732219},
        KS: {Code: 'KS', Party: 'R', Electors: 6, Voters: 1208320, Population: 2913314},
        KY: {Code: 'KY', Party: 'R', Electors: 8, Voters: 1751658, Population: 4467673},
        LA: {Code: 'LA', Party: 'R', Electors: 8, Voters: 2144394, Population: 4648794},
        MA: {Code: 'MA', Party: 'D', Electors: 11, Voters: 5525047, Population: 6949503},
        MD: {Code: 'MD', Party: 'D', Electors: 10, Voters: 4610011, Population: 6045680},
        ME: {Code: 'ME', Party: 'D', Electors: 4, Voters: 1003990, Population: 1344212},
        MI: {Code: 'MI', Party: 'R', Electors: 16, Voters: 11814019, Population: 9986857},
        MN: {Code: 'MN', Party: 'R', Electors: 10, Voters: 7044975, Population: 5639632},
        MO: {Code: 'MO', Party: 'R', Electors: 10, Voters: 2989243, Population: 6137428},
        MS: {Code: 'MS', Party: 'R', Electors: 6, Voters: 1324289, Population: 2976149},
        MT: {Code: 'MT', Party: 'R', Electors: 3, Voters: 507852, Population: 1068778},
        NC: {Code: 'NC', Party: 'R', Electors: 15, Voters: 11644415, Population: 10488084},
        ND: {Code: 'ND', Party: 'R', Electors: 3, Voters: 274581, Population: 762062},
        NE: {Code: 'NE', Party: 'R', Electors: 5, Voters: 807080, Population: 1934408},
        NH: {Code: 'NH', Party: 'D', Electors: 4, Voters: 971797, Population: 1359711},
        NJ: {Code: 'NJ', Party: 'D', Electors: 14, Voters: 5872828, Population: 8882190},
        NM: {Code: 'NM', Party: 'D', Electors: 5, Voters: 1114673, Population: 2096829},
        NV: {Code: 'NV', Party: 'D', Electors: 6, Voters: 1493386, Population: 3080156},
        NY: {Code: 'NY', Party: 'D', Electors: 29, Voters: 12478133, Population: 19453561},
        OH: {Code: 'OH', Party: 'R', Electors: 18, Voters: 13119914, Population: 11689100},
        OK: {Code: 'OK', Party: 'R', Electors: 7, Voters: 1218494, Population: 3956971},
        OR: {Code: 'OR', Party: 'D', Electors: 7, Voters: 2799917, Population: 4217737},
        PA: {Code: 'PA', Party: 'D', Electors: 20, Voters: 15283931, Population: 12801989},
        RI: {Code: 'RI', Party: 'D', Electors: 4, Voters: 696564, Population: 1059361},
        SC: {Code: 'SC', Party: 'R', Electors: 9, Voters: 2358712, Population: 5148714},
        SD: {Code: 'SD', Party: 'R', Electors: 3, Voters: 337987, Population: 884659},
        TN: {Code: 'TN', Party: 'R', Electors: 11, Voters: 2421274, Population: 6833174},
        TX: {Code: 'TX', Party: 'R', Electors: 38, Voters: 10753736, Population: 28995881},
        UT: {Code: 'UT', Party: 'R', Electors: 6, Voters: 878433, Population: 3205958},
        VA: {Code: 'VA', Party: 'D', Electors: 13, Voters: 5468252, Population: 8535519},
        VT: {Code: 'VT', Party: 'D', Electors: 3, Voters: 492226, Population: 623989},
        WA: {Code: 'WA', Party: 'D', Electors: 12, Voters: 4866218, Population: 7614893},
        WI: {Code: 'WI', Party: 'D', Electors: 10, Voters: 7223309, Population: 5822434},
        WV: {Code: 'WV', Party: 'R', Electors: 5, Voters: 532748, Population: 1792065},
        WY: {Code: 'WY', Party: 'R', Electors: 3, Voters: 164415, Population: 578759},
    }; 
